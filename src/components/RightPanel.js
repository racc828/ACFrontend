  ...
  render() {
    return(
      <div id="right-panel-component">
        ...
        {this.props.selectedProject === null ? <RightPanelHome /> : <Project createList={this.props.createList} deleteList={this.props.deleteList} selectedProject={this.props.selectedProject}/>}
      </div>
    )
  }
